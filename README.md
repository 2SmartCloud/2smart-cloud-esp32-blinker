...
Replace `product_id` in [src/main.cpp](./src/main.cpp) file with your own Product ID from "Connection info" modal.

![image](configuration-info.jpeg)
